...
**方法论文档**：`docs/14_三系统融合决策方法论.md` — 可直接作为操作手册使用
...
**新技能与方法论**：
- **短线冲高选股**：`skills/chip-reversal-stock-picker/` + `docs/15_短线冲高选股与交易方法论.md` — 筹码分歧回补6条件、四维度共振分级、竞价抢筹3情景、主力成本线4价位、健康吸筹/高位派发镜像判据（中天科技实战）
- **A股抖音口播**：`skills/a-share-douyin-koubo/` + `docs/16_A股抖音口播方法论.md` — 五框架（流动性档位/通胀剪刀差/冲锋号/跨境支付/一日五步）+ 三模板（盘前/午间/盘后）+ 写作纪律
...
- [docs/14_三系统融合决策方法论.md](docs/14_三系统融合决策方法论.md) — ★ v3.4 核心新增：独立可执行的方法论文档（L1双闸门+L2三验证+L3三层加权+L4统一风控 · 每日操作SOP · 实战案例）
- [docs/15_短线冲高选股与交易方法论.md](docs/15_短线冲高选股与交易方法论.md) — ★ v3.5 新增：筹码分歧回补6条件+四维共振+竞价抢筹+主力成本线
- [docs/16_A股抖音口播方法论.md](docs/16_A股抖音口播方法论.md) — ★ v3.5 新增：五框架+三模板+写作纪律
- [docs/17_报告输出规范_副文本与涨停池排版.md](docs/17_报告输出规范_副文本与涨停池排版.md) — ★ v3.5 新增：副文本优先铁律+涨停池排版范式+两条铁律+涨停数据来源
