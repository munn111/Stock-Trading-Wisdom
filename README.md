# Stock Trading Wisdom (股票交易智慧库) v3.5

> **最后更新**: 2026-09-21 | **版本**: v3.5 (短线选股+内容产出版)
...
## v3.3 升级要点 (2026-08-09)

| 升级项 | 内容 |
|---|---|
| **认知综合心得** | 新增 `docs/13_交易认知综合心得_博弈结构与纪律闭环.md`，融合市场微观结构(四种人六种情况)+板块生命周期(科技→题材→成长→蓝筹)+神明叙事理论+人性工程化(七种心理)+四层否决权体系 |
| **决策链升级** | 从"选股→买→卖"升级为十步完整决策链，含L0人性否决权+住相信号链五维破裂检测 |
| **选股双引擎** | "神明叙事 × 量化战法"交集选股，先定方向再做选股 |
| **自我审计** | 新增买入前十问检查清单+持仓中七条纪律+每周五问审计 |

---

## v3.4 升级要点 (2026-08-09)

| 升级项 | 内容 |
|---|---|
| **三系统融合决策方法论** | 新增 `docs/14_三系统融合决策方法论.md`：L1双闸门（双系统交叉验证）+ L2三验证（主线锁定）+ L3三层加权评分 + L4统一风控，含每日操作SOP与云南锗业实战案例 |

---

## v3.5 升级要点 (2026-09-21)

| 升级项 | 内容 |
|---|---|
| **短线冲高选股** | 新增 `docs/15_短线冲高选股与交易方法论.md` + `skills/chip-reversal-stock-picker/`：筹码分歧回补6条件 + 四维度共振分级 + 竞价抢筹 + 主力成本线 + 健康吸筹/高位派发镜像判据（中天科技实战） |
| **A股抖音口播** | 新增 `docs/16_A股抖音口播方法论.md` + `skills/a-share-douyin-koubo/`：五框架（流动性档位/通胀剪刀差/冲锋号/跨境支付/一日五步）+ 三模板（盘前/午间/盘后）+ 写作纪律 |
| **报告输出规范** | 新增 `docs/17_报告输出规范_副文本与涨停池排版.md`：副文本优先铁律 + 涨停池排版范式 + 两条铁律（完整全量/板块强度排序）+ 涨停数据来源 |
| **情绪周期校准** | `memory/emotion_cycle.md` 补充 9 月涨停序列：9/8 73 → 9/15 32(冰点) → 9/16 91(冰点反转) → 9/21 105(高潮无高度·首板扩散) |

> 注：v3.4 为「三系统融合决策方法论」（docs/14），本次 v3.5 在其基础上新增短线选股与内容产出两条新能力线。
